 ...
 */
/**
 * Created by sulite on 2017/9/7.
 */
public class SendMailUtil {

    private static final String from = "service@vpclub.cn";
    private static final String fromName = "考核系统";
    private static final String charSet = "utf-8";
    private static final String username = "service@vpclub.cn";
    private static final String password = "VPclub.888";
    ...
    static {
        ...
        //vpclub
        hostMap.put("smtp.vpclub", "smtp.exmail.qq.com");
    }
    ...
    public static void main(String[] args) {
        ...
        sendFtlMail("gao.yuanli@vpclub.cn", "sendemail test!", templatePath, map);
