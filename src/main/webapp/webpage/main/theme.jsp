	...
	<div class="page-header-inner">
		...
		<div class="page-logo">
			<div style="margin-top: 8px;">
				<span style="color: #fff;font-size: 22px;">微品</span><span style="color: #fff;font-size: 22px;">月度考核管理系统</span>
			</div>
			<%-- <a href="#">
		...
		<div class="top-menu">
			<ul class="nav navbar-nav pull-right">
				...
				<li class="dropdown dropdown-user">
					...
					<%--<img alt="" class="img-circle" src="${webRoot}/${USER_LOGIN.userPhoto}"/>--%>
					<span class="username username-hide-on-mobile">${USER_LOGIN.name}</span>
					<i class="fa fa-angle-down"></i>
					</a>
					<ul class="dropdown-menu dropdown-menu-default">
						<li>
						 <a href="javascript:;" onclick="menu(this,'/user/jump')">
				...
				<li class="dropdown dropdown-quick-sidebar-toggler" style="display: none;">
					<a href="<c:url value="/login/logout"></c:url>" class="dropdown-toggle">					
...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title" style="display: none;">首页</h3>
...
<!-- END FOOTER -->	
	...
	<script src="${webRoot}/static/global/plugins/jquery-validation/js/jquery.validate.min.js?v=20170801112233" type="text/javascript"></script>
	...
	<script src="${webRoot}/static/custom/common.js?v=20170801112233" type="text/javascript"></script>
</body>
</html>